    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">          
          <ul>
              <li><a style="float: right;color: #00aa00;" href="<?php echo Url::to(['reply/index']);?>">添加</a><a href="<?php echo Url::to(['reply/list']);?>" <?php if($controllerID=='reply' && $actionID=='index'){ ?> class="active" <?php } ?>><i class="fa fa-home fa-fw"></i>自动回复</a></li>
            <li><a href="<?php echo Url::to(['menu/index']);?>" <?php if($controllerID=='menu' && $actionID=='index'){ ?> class="active" <?php } ?>><i class="fa fa-database fa-fw"></i>自定义菜单</a></li>
            <li><a href="<?php echo Url::to(['login/clea']);?>"><i class="fa fa-eject fa-fw"></i>退出</a></li>
          </ul>  
        </nav>
      </div>
        <div class="templatemo-content col-1 light-gray-bg">
            <div class="templatemo-top-nav-container">
                <div class="row">
                    ...
                    <a id="q" class="active">欢迎<span style="color:orange"><?php echo $_COOKIE['name']?></span>登陆</a>
                </div>
            </div>
            <style>
                #q{
