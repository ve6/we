...
<title>微e - 微信公众平台自助引擎 -  Powered by WE6</title>
...
<script type="text/javascript">
	...
	function saveMenu() {
		...
		dat = dat.slice(0,-1);
		dat += ']';
		$.post("index.php?r=menu/insert", { menu:dat } , function(data){
			...
			<?php foreach($menu as $key=>$val){
				if(isset($val['type'])){
					?>
									...
									<tr class="hover" data-do="<?= $val['type']=='view'?'view':'forward'?>" data-url="<?= isset($val['url'])?$val['url']:''?>" data-forward="<?= isset($val['key'])?$val['key']:''?>">
					<td>
						<div>
							<input type="text" class="span4" value="<?php echo $val['name'] ?>"> &nbsp; &nbsp;
							<a href="javascript:;" class="icon-move" title="拖动调整此菜单位置"></a> &nbsp;
							<a href="javascript:;" onclick="setMenuAction($(this).parent().parent().parent());" class="icon-edit" title="设置此菜单动作" url="<?php echo $val['url'] ?>"></a> &nbsp;
							<a href="javascript:;" onclick="deleteMenu(this)" class="icon-remove-sign" title="删除此菜单"></a> &nbsp;
				...
				<?php	}else{ ?>
					...
					<td>
						...
						<div class="smlist ui-sortable">
						<?php foreach($val['sub_button'] as $k=>$v){ ?>

							<div style="margin-top:20px;padding-left:80px;background:url(&#39;./resource/image/bg_repno.gif&#39;) no-repeat -245px -545px;" data-do="<?= $v['type']=='view'?'view':'forward'?>" data-url="<?= isset($v['url'])?$v['url']:''?>" data-forward="<?= isset($v['key'])?$v['key']:''?>">
								<input type="text" class="span3" value="<?php echo $v['name'] ?>"> &nbsp; &nbsp;
								<a href="javascript:;" class="icon-move" title="拖动调整此菜单位置"></a> &nbsp;
								<a href="javascript:;" onclick="setMenuAction($(this).parent());" class="icon-edit" title="设置此菜单动作"></a> &nbsp;
								<a href="javascript:;" onclick="deleteMenu(this)" class="icon-remove-sign" title="删除此菜单"></a>
							</div>
...
<div id="dialog" class="modal hide">
	...
	<div id="footer">
		<span class="pull-left">
			<p>Powered by <a href=""><b>微e</b></a> ve6 © 2016 <a href=""></a></p>
		</span>
		<span class="pull-right">
			<p><a href="">关于微e</a>&nbsp;&nbsp;<a href="">微e帮助</a></p>
		</span>
	</div>
