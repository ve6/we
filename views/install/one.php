...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<title>安装系统 - V E公众平台自助开源引擎</title>
	...
	<body style="background-color:#28b0e4;">
		...
		<form action='index.php?r=install/two' class="form-inline" role="form" method="post">
			<ul class="pager">
				...
				<li class="previous"><a href="javascript:;" onclick="if(jQuery(&#39;:checkbox:checked&#39;).length == 1){$(this).attr('href','index.php?r=install/two');}else{alert('您必须同意软件许可协议才能安装！')};">继续 <span class="glyphicon glyphicon-chevron-right"></span></a></li>
			</ul>
		</form>
				</div>
			</div>
